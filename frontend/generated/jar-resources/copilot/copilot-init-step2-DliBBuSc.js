...
let ne = class extends L {
  ...
  getStatus() {
    if (a.userInfo?.validLicense)
      return a.userInfo?.copilotProjectCannotLeaveLocalhost ? "AI disabled" : void 0;
    if ($.active) {
