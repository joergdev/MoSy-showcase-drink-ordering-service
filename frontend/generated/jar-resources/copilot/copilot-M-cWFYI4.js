...
const un = async (e, t, n) => window.Vaadin.copilot.comm(e, t, n), he = "copilot-", Us = "24.6.7", Hc = "attention-required", Kc = "https://plugins.jetbrains.com/plugin/23758-vaadin", qc = "https://marketplace.visualstudio.com/items?itemName=vaadin.vaadin-vscode";
function Wc(e) {
...
function Tl() {
  Ee.push(import("./copilot-log-plugin-Cma0cb7P.js")), Ee.push(import("./copilot-info-plugin-ChnlgWeI.js")), Ee.push(import("./copilot-features-plugin-DeQh5sfn.js")), Ee.push(import("./copilot-feedback-plugin-1rpyDEsX.js")), Ee.push(import("./copilot-shortcuts-plugin-BHuVcOUz.js"));
}
function kl() {
  {
...
let Jr = class extends Dl {
  ...
  async init() {
    if (this.initialized)
      return;
    await window.Vaadin.copilot._machineState.initializer.promise, await import("./copilot-global-vars-later-BjbLUkOt.js"), await import("./copilot-init-step2-DliBBuSc.js"), Gs(), Tl(), this.tabIndex = 0, Tt.hostConnectedCallback(), window.addEventListener("keydown", Lr), y.onSend(this.handleSendEvent), this.removers.push(y.on("close-drawers", this.closeDrawers.bind(this))), this.removers.push(
